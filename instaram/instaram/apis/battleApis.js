...
// localhost:8080/battle/serchBattle?king=Robb Stark&location=Riverrun&type=ambush
// search is implemented on attacker_king or defender_king, location and battle_type.
exports.searchBattle = function (req, res) {
	let query;
...
// localhost:8080/battle/countBattle
// count the number of battle occured.
exports.countBattle = function(req, res) {
...
// localhost:8080/battle/listBattle
// list of battle places
exports.listBattle = function(req, res) {
	let collection = req.app.schema.battles;
	let query = [
		{
			"$group" : {
...
exports.statsBattle = function(req, res) {
	let collection = req.app.schema.battles;
	...
	/*attackerKingPromise.then((doc) => {
		console.log("Doc : ",doc);
		defenderKingPromise.then((doc1) => {
